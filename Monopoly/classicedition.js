...
chanceCards[0] = new Card("Card1");
chanceCards[1] = new Card("Card2");
chanceCards[2] = new Card("Card3");
chanceCards[3] = new Card("Card4");
chanceCards[4] = new Card("Card5");
chanceCards[5] = new Card("Card6");
chanceCards[6] = new Card("Card7");
chanceCards[7] = new Card("Card8");
chanceCards[8] = new Card("Card9");
chanceCards[9] = new Card("Card10");
chanceCards[10] = new Card("Card11");
chanceCards[11] = new Card("Card12");
chanceCards[12] = new Card("Card13");
chanceCards[13] = new Card("Card14");
chanceCards[14] = new Card("Card15");
chanceCards[15] = new Card("Card16");

// start game by picking card and it says go to place and they win that card, and removes it for the rest of the game.