...
$(function () {
  var words = ['elephant', 'giraffe', 'lion', 'tiger', 'zebra', 'monkey', 'panda', 'kangaroo', 'koala', 'dolphin', 'penguin', 'rhino',
 'hippo', 'cheetah', 'gorilla', 'ostrich', 'octopus', 'wolf', 'bear', 'eagle', 'seal', 'sloth'];
