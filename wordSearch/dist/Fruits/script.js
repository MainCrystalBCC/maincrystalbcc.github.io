...
$(function () {
  var words = ['apple', 'banana', 'orange', 'strawberry', 'pineapple', 'watermelon', 'grape', 'kiwi', 'mango', 'peach', 'pear', 'cherry',
 'blueberry', 'raspberry', 'lemon', 'lime', 'coconut', 'avocado', 'papaya', 'fig', 'plum', 'apricot'];
