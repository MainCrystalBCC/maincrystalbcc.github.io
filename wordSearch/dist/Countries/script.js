...
$(function () {
  var words = ['france', 'italy', 'brazil', 'china', 'canada', 'mexico', 'japan', 'germany', 'australia', 'spain', 'india', 'russia',
 'argentina', 'egypt', 'turkey', 'thailand', 'greece', 'sweden', 'norway', 'kenya', 'iran', 'poland'];
